...
const IRAQI_SLANG_NORMALIZATION_MAP = {
  // Tables
  ميز: ['مائدة', 'طاولة', 'طاولات', 'ميزات', 'دوكة', 'دوكات'],
  مائدة: ['مائدة', 'طاولة', 'طاولات', 'ميز', 'ميزات', 'دوكة', 'دوكات'],
  طاولة: ['مائدة', 'طاولة', 'طاولات', 'ميز', 'ميزات', 'دوكة', 'دوكات'],
  طاولات: ['مائدة', 'طاولة', 'ميز', 'ميزات', 'دوكة', 'دوكات'],
  ميزات: ['مائدة', 'طاولة', 'طاولات', 'ميز', 'دوكة', 'دوكات'],
  دوكة: ['مائدة', 'طاولة', 'طاولات', 'ميز', 'ميزات', 'دوكات'],
  دوكات: ['مائدة', 'طاولة', 'طاولات', 'ميز', 'ميزات', 'دوكة'],
  
  // Chairs
  كعدي: ['كرسي', 'كراسي', 'مقعد', 'مقاعد'],
  كرسي: ['كرسي', 'كراسي', 'مقعد', 'مقاعد', 'كعدي'],
  كراسي: ['كرسي', 'مقعد', 'مقاعد', 'كعدي'],
  مقعد: ['كرسي', 'كراسي', 'مقاعد', 'كعدي'],
  مقاعد: ['كرسي', 'كراسي', 'مقعد', 'كعدي'],
  
  // Beds
  جربايه: ['سرير', 'سراير', 'سريرات', 'أسرّة', 'مضاجع', 'مضجع', 'فراش', 'فرشة'],
  جرباية: ['سرير', 'سراير', 'أسرّة', 'مضاجع', 'مضجع', 'فراش', 'فرشة'],
  سرير: ['سرير', 'سراير', 'أسرّة', 'مضاجع', 'مضجع', 'فراش', 'فرشة', 'جربايه', 'جرباية'],
  سراير: ['سرير', 'أسرّة', 'مضاجع', 'مضجع', 'فراش', 'فرشة', 'جربايه', 'جرباية'],
  أسرّة: ['سرير', 'سراير', 'مضاجع', 'مضجع', 'فراش', 'فرشة', 'جربايه', 'جرباية'],
  مضاجع: ['سرير', 'سراير', 'أسرّة', 'مضجع', 'فراش', 'فرشة', 'جربايه', 'جرباية'],
  مضجع: ['سرير', 'سراير', 'أسرّة', 'مضاجع', 'فراش', 'فرشة', 'جربايه', 'جرباية'],
  فراش: ['سرير', 'سراير', 'أسرّة', 'مضاجع', 'مضجع', 'فرشة', 'جربايه', 'جرباية'],
  فرشة: ['سرير', 'سراير', 'أسرّة', 'مضاجع', 'مضجع', 'فراش', 'جربايه', 'جرباية'],
  
  // Sofas
  كاناب: ['كنبة', 'كنب', 'أريكة', 'أرائك', 'كانابات', 'كانبوه', 'قنفه', 'قنفات', 'صوفة', 'صوفات'],
  كانابات: ['كنبة', 'كنب', 'أريكة', 'أرائك', 'كاناب', 'كانبوه', 'قنفه', 'قنفات', 'صوفة', 'صوفات'],
  كانبوه: ['كنبة', 'كنب', 'أريكة', 'أرائك', 'كاناب', 'كانابات', 'قنفه', 'قنفات', 'صوفة', 'صوفات'],
  قنفه: ['كنبة', 'كنب', 'أريكة', 'أرائك', 'كاناب', 'كانابات', 'كانبوه', 'قنفات', 'صوفة', 'صوفات'],
  قنفات: ['كنبة', 'كنب', 'أريكة', 'أرائك', 'كاناب', 'كانابات', 'كانبوه', 'قنفه', 'صوفة', 'صوفات'],
  صوفة: ['كنبة', 'كنب', 'أريكة', 'أرائك', 'كاناب', 'كانابات', 'كانبوه', 'قنفه', 'قنفات', 'صوفات'],
  صوفات: ['كنبة', 'كنب', 'أريكة', 'أرائك', 'كاناب', 'كانابات', 'كانبوه', 'قنفه', 'قنفات', 'صوفة'],
  كنبة: ['كنبة', 'كنب', 'أريكة', 'أرائك', 'كاناب', 'كانابات', 'كانبوه', 'قنفه', 'قنفات', 'صوفة', 'صوفات'],
  كنب: ['كنبة', 'أريكة', 'أرائك', 'كاناب', 'كانابات', 'كانبوه', 'قنفه', 'قنفات', 'صوفة', 'صوفات'],
  أريكة: ['كنبة', 'كنب', 'أرائك', 'كاناب', 'كانابات', 'كانبوه', 'قنفه', 'قنفات', 'صوفة', 'صوفات'],
  أرائك: ['كنبة', 'كنب', 'أريكة', 'كاناب', 'كانابات', 'كانبوه', 'قنفه', 'قنفات', 'صوفة', 'صوفات'],
  
  // Clothes
  حلا: ['ملابس', 'لباس', 'ثياب', 'شلغ', 'شلغات', 'شماغ', 'شماغات', 'دشداشة', 'دشداشات', 'مكناسه'],
  شلغ: ['ملابس', 'لباس', 'ثياب', 'حلا', 'شلغات', 'شماغ', 'شماغات', 'دشداشة', 'دشداشات', 'مكناسه'],
  شلغات: ['ملابس', 'لباس', 'ثياب', 'حلا', 'شلغ', 'شماغ', 'شماغات', 'دشداشة', 'دشداشات', 'مكناسه'],
  شماغ: ['ملابس', 'لباس', 'ثياب', 'حلا', 'شلغ', 'شلغات', 'شماغات', 'دشداشة', 'دشداشات', 'مكناسه'],
  شماغات: ['ملابس', 'لباس', 'ثياب', 'حلا', 'شلغ', 'شلغات', 'شماغ', 'دشداشة', 'دشداشات', 'مكناسه'],
  دشداشة: ['ملابس', 'لباس', 'ثياب', 'حلا', 'شلغ', 'شلغات', 'شماغ', 'شماغات', 'دشداشات', 'مكناسه'],
  دشداشات: ['ملابس', 'لباس', 'ثياب', 'حلا', 'شلغ', 'شلغات', 'شماغ', 'شماغات', 'دشداشة', 'مكناسه'],
  مكناسه: ['ملابس', 'لباس', 'ثياب', 'حلا', 'شلغ', 'شلغات', 'شماغ', 'شماغات', 'دشداشة', 'دشداشات'],
  ملابس: ['ملابس', 'لباس', 'ثياب', 'حلا', 'شلغ', 'شلغات', 'شماغ', 'شماغات', 'دشداشة', 'دشداشات', 'مكناسه'],
  لباس: ['ملابس', 'ثياب', 'حلا', 'شلغ', 'شلغات', 'شماغ', 'شماغات', 'دشداشة', 'دشداشات', 'مكناسه'],
  ثياب: ['ملابس', 'لباس', 'حلا', 'شلغ', 'شلغات', 'شماغ', 'شماغات', 'دشداشة', 'دشداشات', 'مكناسه'],
  
  // Pants
  بنط: ['بنطلون', 'بنطلونات', 'بناطيل', 'سراويل', 'سروال', 'سروالات', 'بنط'],
  بنطال: ['بنطلون', 'بنطلونات', 'بناطيل', 'سراويل', 'سروال', 'سروالات', 'بنط'],
  بنطلون: ['بنطلون', 'بنطلونات', 'بناطيل', 'سراويل', 'سروال', 'سروالات', 'بنط', 'بنطال'],
  بنطلونات: ['بنطلون', 'بناطيل', 'سراويل', 'سروال', 'سروالات', 'بنط', 'بنطال'],
  بناطيل: ['بنطلون', 'بنطلونات', 'سراويل', 'سروال', 'سروالات', 'بنط', 'بنطال'],
  سراويل: ['بنطلون', 'بنطلونات', 'بناطيل', 'سروال', 'سروالات', 'بنط', 'بنطال'],
  سروال: ['بنطلون', 'بنطلونات', 'بناطيل', 'سراويل', 'سروالات', 'بنط', 'بنطال'],
  سروالات: ['بنطلون', 'بنطلونات', 'بناطيل', 'سراويل', 'سروال', 'بنط', 'بنطال'],
  
  // Dresses
  دریسة: ['فستان', 'فساتين', 'رداء', 'أردية', 'دریسات'],
  دریسات: ['فستان', 'فساتين', 'رداء', 'أردية', 'دریسة'],
  فستان: ['فستان', 'فساتين', 'رداء', 'أردية', 'دریسة', 'دریسات'],
  فساتين: ['فستان', 'رداء', 'أردية', 'دریسة', 'دریسات'],
  رداء: ['فستان', 'فساتين', 'أردية', 'دریسة', 'دریسات'],
  أردية: ['فستان', 'فساتين', 'رداء', 'دریسة', 'دریسات'],
  
  // Shoes
  كندره: ['حذاء', 'أحذية', 'حذ', 'كندره', 'كنادر', 'شبشب', 'شباشب', 'صندل', 'صنادل', 'حفلة', 'حفلات', 'كلاج', 'كلاجات'],
  كنادر: ['حذاء', 'أحذية', 'حذ', 'كندره', 'شبشب', 'شباشب', 'صندل', 'صنادل', 'حفلة', 'حفلات', 'كلاج', 'كلاجات'],
  كلاج: ['حذاء', 'أحذية', 'حذ', 'كندره', 'كنادر', 'شبشب', 'شباشب', 'صندل', 'صنادل', 'حفلة', 'حفلات', 'كلاجات'],
  كلاجات: ['حذاء', 'أحذية', 'حذ', 'كندره', 'كنادر', 'شبشب', 'شباشب', 'صندل', 'صنادل', 'حفلة', 'حفلات', 'كلاج'],
  حذاء: ['حذاء', 'أحذية', 'حذ', 'كندره', 'كنادر', 'شبشب', 'شباشب', 'صندل', 'صنادل', 'حفلة', 'حفلات', 'كلاج', 'كلاجات'],
  أحذية: ['حذاء', 'حذ', 'كندره', 'كنادر', 'شبشب', 'شباشب', 'صندل', 'صنادل', 'حفلة', 'حفلات', 'كلاج', 'كلاجات'],
  حذ: ['حذاء', 'أحذية', 'كندره', 'كنادر', 'شبشب', 'شباشب', 'صندل', 'صنادل', 'حفلة', 'حفلات', 'كلاج', 'كلاجات'],
  شبشب: ['حذاء', 'أحذية', 'حذ', 'كندره', 'كنادر', 'شباشب', 'صندل', 'صنادل', 'حفلة', 'حفلات', 'كلاج', 'كلاجات'],
  شباشب: ['حذاء', 'أحذية', 'حذ', 'كندره', 'كنادر', 'شبشب', 'صندل', 'صنادل', 'حفلة', 'حفلات', 'كلاج', 'كلاجات'],
  صندل: ['حذاء', 'أحذية', 'حذ', 'كندره', 'كنادر', 'شبشب', 'شباشب', 'صنادل', 'حفلة', 'حفلات', 'كلاج', 'كلاجات'],
  صنادل: ['حذاء', 'أحذية', 'حذ', 'كندره', 'كنادر', 'شبشب', 'شباشب', 'صندل', 'حفلة', 'حفلات', 'كلاج', 'كلاجات'],
  حفلة: ['حذاء', 'أحذية', 'حذ', 'كندره', 'كنادر', 'شبشب', 'شباشب', 'صندل', 'صنادل', 'حفلات', 'كلاج', 'كلاجات'],
  حفلات: ['حذاء', 'أحذية', 'حذ', 'كندره', 'كنادر', 'شبشب', 'شباشب', 'صندل', 'صنادل', 'حفلة', 'كلاج', 'كلاجات'],
  
  // Phones
  نق: ['هاتف', 'هواتف', 'موبايل', 'موبايلات', 'جوال', 'جوالات', 'نق'],
  هاتف: ['هاتف', 'هواتف', 'موبايل', 'موبايلات', 'جوال', 'جوالات', 'نق'],
  هواتف: ['هاتف', 'موبايل', 'موبايلات', 'جوال', 'جوالات', 'نق'],
  موبايل: ['هاتف', 'هواتف', 'موبايلات', 'جوال', 'جوالات', 'نق'],
  موبايلات: ['هاتف', 'هواتف', 'موبايل', 'جوال', 'جوالات', 'نق'],
  جوال: ['هاتف', 'هواتف', 'موبايل', 'موبايلات', 'جوالات', 'نق'],
  جوالات: ['هاتف', 'هواتف', 'موبايل', 'موبايلات', 'جوال', 'نق'],
  
  // Watches
  راص: ['ساعة', 'ساعات', 'ساعه', 'سواعت', 'راص'],
  ساعة: ['ساعة', 'ساعات', 'ساعه', 'سواعت', 'راص'],
  ساعات: ['ساعة', 'ساعه', 'سواعت', 'راص'],
  ساعه: ['ساعة', 'ساعات', 'سواعت', 'راص'],
  سواعت: ['ساعة', 'ساعات', 'ساعه', 'راص'],
  
  // Kitchen
  طنجرة: ['أواني', 'وعاء', 'قدر', 'قدور', 'طنجرة', 'طناجر', 'قلايه', 'قلايات', 'طاسة', 'طاس', 'طاسات', 'صحن', 'صحون', 'ملعقة', 'ملاعق', 'شوكة', 'شوك', 'سكين', 'سكاكين'],
  طناجر: ['أواني', 'وعاء', 'قدر', 'قدور', 'طنجرة', 'قلايه', 'قلايات', 'طاسة', 'طاس', 'طاسات', 'صحن', 'صحون', 'ملعقة', 'ملاعق', 'شوكة', 'شوك', 'سكين', 'سكاكين'],
  قلايه: ['أواني', 'وعاء', 'قدر', 'قدور', 'طنجرة', 'طناجر', 'قلايات', 'طاسة', 'طاس', 'طاسات', 'صحن', 'صحون', 'ملعقة', 'ملاعق', 'شوكة', 'شوك', 'سكين', 'سكاكين'],
  قلايات: ['أواني', 'وعاء', 'قدر', 'قدور', 'طنجرة', 'طناجر', 'قلايه', 'طاسة', 'طاس', 'طاسات', 'صحن', 'صحون', 'ملعقة', 'ملاعق', 'شوكة', 'شوك', 'سكين', 'سكاكين'],
  طاسة: ['أواني', 'وعاء', 'قدر', 'قدور', 'طنجرة', 'طناجر', 'قلايه', 'قلايات', 'طاس', 'طاسات', 'صحن', 'صحون', 'ملعقة', 'ملاعق', 'شوكة', 'شوك', 'سكين', 'سكاكين'],
  طاس: ['أواني', 'وعاء', 'قدر', 'قدور', 'طنجرة', 'طناجر', 'قلايه', 'قلايات', 'طاسة', 'طاسات', 'صحن', 'صحون', 'ملعقة', 'ملاعق', 'شوكة', 'شوك', 'سكين', 'سكاكين'],
  طاسات: ['أواني', 'وعاء', 'قدر', 'قدور', 'طنجرة', 'طناجر', 'قلايه', 'قلايات', 'طاسة', 'طاس', 'صحن', 'صحون', 'ملعقة', 'ملاعق', 'شوكة', 'شوك', 'سكين', 'سكاكين'],
  صحن: ['أواني', 'وعاء', 'قدر', 'قدور', 'طنجرة', 'طناجر', 'قلايه', 'قلايات', 'طاسة', 'طاس', 'طاسات', 'صحون', 'ملعقة', 'ملاعق', 'شوكة', 'شوك', 'سكين', 'سكاكين'],
  صحون: ['أواني', 'وعاء', 'قدر', 'قدور', 'طنجرة', 'طناجر', 'قلايه', 'قلايات', 'طاسة', 'طاس', 'طاسات', 'صحن', 'ملعقة', 'ملاعق', 'شوكة', 'شوك', 'سكين', 'سكاكين'],
  ملعقة: ['أواني', 'وعاء', 'قدر', 'قدور', 'طنجرة', 'طناجر', 'قلايه', 'قلايات', 'طاسة', 'طاس', 'طاسات', 'صحن', 'صحون', 'ملاعق', 'شوكة', 'شوك', 'سكين', 'سكاكين'],
  ملاعق: ['أواني', 'وعاء', 'قدر', 'قدور', 'طنجرة', 'طناجر', 'قلايه', 'قلايات', 'طاسة', 'طاس', 'طاسات', 'صحن', 'صحون', 'ملعقة', 'شوكة', 'شوك', 'سكين', 'سكاكين'],
  شوكة: ['أواني', 'وعاء', 'قدر', 'قدور', 'طنجرة', 'طناجر', 'قلايه', 'قلايات', 'طاسة', 'طاس', 'طاسات', 'صحن', 'صحون', 'ملعقة', 'ملاعق', 'شوك', 'سكين', 'سكاكين'],
  شوك: ['أواني', 'وعاء', 'قدر', 'قدور', 'طنجرة', 'طناجر', 'قلايه', 'قلايات', 'طاسة', 'طاس', 'طاسات', 'صحن', 'صحون', 'ملعقة', 'ملاعق', 'شوكة', 'سكين', 'سكاكين'],
  سكين: ['أواني', 'وعاء', 'قدر', 'قدور', 'طنجرة', 'طناجر', 'قلايه', 'قلايات', 'طاسة', 'طاس', 'طاسات', 'صحن', 'صحون', 'ملعقة', 'ملاعق', 'شوكة', 'شوك', 'سكاكين'],
  سكاكين: ['أواني', 'وعاء', 'قدر', 'قدور', 'طنجرة', 'طناجر', 'قلايه', 'قلايات', 'طاسة', 'طاس', 'طاسات', 'صحن', 'صحون', 'ملعقة', 'ملاعق', 'شوكة', 'شوك', 'سكين'],
  
  // Electronics
  ماطور: ['إلكترونيات', 'أجهزة', 'جهاز', 'ماطور', 'مطورات', 'مولده', 'مولدات', 'مولد', 'راديو'],
  مطورات: ['إلكترونيات', 'أجهزة', 'جهاز', 'ماطور', 'مولده', 'مولدات', 'مولد', 'راديو'],
  مولده: ['إلكترونيات', 'أجهزة', 'جهاز', 'ماطور', 'مطورات', 'مولدات', 'مولد', 'راديو'],
  مولدات: ['إلكترونيات', 'أجهزة', 'جهاز', 'ماطور', 'مطورات', 'مولده', 'مولد', 'راديو'],
  مولد: ['إلكترونيات', 'أجهزة', 'جهاز', 'ماطور', 'مطورات', 'مولده', 'مولدات', 'راديو'],
  راديو: ['إلكترونيات', 'أجهزة', 'جهاز', 'ماطور', 'مطورات', 'مولده', 'مولدات', 'مولد'],
  
  // Refrigerator
  ثلاجه: ['ثلاجة', 'ثلاجات', 'براد', 'برادات', 'ثلاجه'],
  ثلاجة: ['ثلاجة', 'ثلاجات', 'براد', 'برادات', 'ثلاجه'],
  ثلاجات: ['ثلاجة', 'براد', 'برادات', 'ثلاجه'],
  براد: ['ثلاجة', 'ثلاجات', 'برادات', 'ثلاجه'],
  برادات: ['ثلاجة', 'ثلاجات', 'براد', 'ثلاجه'],
  
  // Furniture - General
  كنتور: ['أثاث', 'مفروشات', 'خزانة', 'خزائن', 'كنتور', 'كنتورات'],
  كنتورات: ['أثاث', 'مفروشات', 'خزانة', 'خزائن', 'كنتور'],
  خزانة: ['أثاث', 'مفروشات', 'خزائن', 'كنتور', 'كنتورات'],
  خزائن: ['أثاث', 'مفروشات', 'خزانة', 'كنتور', 'كنتورات'],
  أثاث: ['أثاث', 'مفروشات', 'خزانة', 'خزائن', 'كنتور', 'كنتورات'],
  مفروشات: ['أثاث', 'خزانة', 'خزائن', 'كنتور', 'كنتورات'],
  
  // Cables
  وائر: ['سلك', 'أسلاك', 'كابل', 'كابلات', 'وائر', 'وائرات', 'تقسيم', 'تقاسيم'],
  وائرات: ['سلك', 'أسلاك', 'كابل', 'كابلات', 'وائر', 'تقسيم', 'تقاسيم'],
  تقسيم: ['سلك', 'أسلاك', 'كابل', 'كابلات', 'وائر', 'وائرات', 'تقاسيم'],
  تقاسيم: ['سلك', 'أسلاك', 'كابل', 'كابلات', 'وائر', 'وائرات', 'تقسيم'],
  سلك: ['سلك', 'أسلاك', 'كابل', 'كابلات', 'وائر', 'وائرات', 'تقسيم', 'تقاسيم'],
  أسلاك: ['سلك', 'كابل', 'كابلات', 'وائر', 'وائرات', 'تقسيم', 'تقاسيم'],
  كابل: ['سلك', 'أسلاك', 'كابلات', 'وائر', 'وائرات', 'تقسيم', 'تقاسيم'],
  كابلات: ['سلك', 'أسلاك', 'كابل', 'وائر', 'وائرات', 'تقسيم', 'تقاسيم'],
  
  // Car
  كرك: ['سيارة', 'سيارات', 'عربة', 'عربات', 'كرك', 'كركات', 'باص', 'باصات', 'تاكسي', 'كوستر'],
  كركات: ['سيارة', 'سيارات', 'عربة', 'عربات', 'كرك', 'باص', 'باصات', 'تاكسي', 'كوستر'],
  باص: ['سيارة', 'سيارات', 'عربة', 'عربات', 'كرك', 'كركات', 'باصات', 'تاكسي', 'كوستر'],
  باصات: ['سيارة', 'سيارات', 'عربة', 'عربات', 'كرك', 'كركات', 'باص', 'تاكسي', 'كوستر'],
  تاكسي: ['سيارة', 'سيارات', 'عربة', 'عربات', 'كرك', 'كركات', 'باص', 'باصات', 'كوستر'],
  كوستر: ['سيارة', 'سيارات', 'عربة', 'عربات', 'كرك', 'كركات', 'باص', 'باصات', 'تاكسي'],
  سيارة: ['سيارة', 'سيارات', 'عربة', 'عربات', 'كرك', 'كركات', 'باص', 'باصات', 'تاكسي', 'كوستر'],
  سيارات: ['سيارة', 'عربة', 'عربات', 'كرك', 'كركات', 'باص', 'باصات', 'تاكسي', 'كوستر'],
  عربة: ['سيارة', 'سيارات', 'عربات', 'كرك', 'كركات', 'باص', 'باصات', 'تاكسي', 'كوستر'],
  عربات: ['سيارة', 'سيارات', 'عربة', 'كرك', 'كركات', 'باص', 'باصات', 'تاكسي', 'كوستر'],
  
  // Bicycle
  بيك: ['دراجة', 'دراجات', 'دراجة هوائية', 'بيك', 'بيكات'],
  بيكات: ['دراجة', 'دراجات', 'دراجة هوائية', 'بيك'],
  دراجة: ['دراجة', 'دراجات', 'دراجة هوائية', 'بيك', 'بيكات'],
  دراجات: ['دراجة', 'دراجة هوائية', 'بيك', 'بيكات'],
  'دراجة هوائية': ['دراجة', 'دراجات', 'بيك', 'بيكات']
};
...
app.get('/api/products/:id/similar', async (req, res) => {
  try {
    ...
    console.log(`[Similar Products] Fetching similar products for product ${productId}`);
