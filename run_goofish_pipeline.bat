...
set GOOFISH_DB_CONNECT_TIMEOUT_MS=15000
set GOOFISH_DB_CONNECT_RETRIES=1
set GOOFISH_DB_CONNECT_RETRY_DELAY_MS=1000
...
set GOOFISH_PIPELINE_RESTART_DELAY_SEC=5
...
echo.
echo Pipeline exited with code %GOOFISH_PIPELINE_EXIT%. Waiting %GOOFISH_PIPELINE_RESTART_DELAY_SEC%s, then resuming from saved progress...
powershell -NoProfile -Command "Start-Sleep -Seconds %GOOFISH_PIPELINE_RESTART_DELAY_SEC%"
goto pipeline_loop
:pipeline_failed
echo.
