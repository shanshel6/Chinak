...
if not defined MEILI_REINDEX_BATCH_SIZE set "MEILI_REINDEX_BATCH_SIZE=50"
if not defined MEILI_REINDEX_BATCH_DOWNSHIFT_SEQUENCE set "MEILI_REINDEX_BATCH_DOWNSHIFT_SEQUENCE=200,100,50,25"
...
if not defined MEILI_REINDEX_MAX_STALLED_MINUTES set "MEILI_REINDEX_MAX_STALLED_MINUTES=45"
if not defined MEILI_REINDEX_STATUS_HEARTBEAT_SECONDS set "MEILI_REINDEX_STATUS_HEARTBEAT_SECONDS=60"
