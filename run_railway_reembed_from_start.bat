...
if not defined REEMBED_START_ID set "REEMBED_START_ID=0"
if not defined REEMBED_RESET_PROGRESS set "REEMBED_RESET_PROGRESS=1"
if not defined REEMBED_FORCE_ALL set "REEMBED_FORCE_ALL=1"
if not defined REEMBED_ASSIGN_CATEGORIES set "REEMBED_ASSIGN_CATEGORIES=0"
if not defined SILICONFLOW_MODEL set "SILICONFLOW_MODEL=Qwen/Qwen3-8B"
...
if not defined REEMBED_QUERY_TIMEOUT_MS set "REEMBED_QUERY_TIMEOUT_MS=90000"
if not defined REEMBED_UPDATE_TIMEOUT_MS set "REEMBED_UPDATE_TIMEOUT_MS=180000"
...
echo SILICONFLOW_MODEL=%SILICONFLOW_MODEL%
