  ...
  return (
    <div className="flex min-h-screen bg-slate-50 dark:bg-slate-950 font-display rtl" dir="rtl">
      ...
      <div className="flex-1 flex flex-col min-w-0 transition-all duration-300">
        {/* Header */}
        <header className="h-16 lg:h-20 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-30 pt-safe">
