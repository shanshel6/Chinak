...
const Profile: React.FC = () => {
  ...
  return (
    <div className="relative flex flex-col w-full max-w-md mx-auto min-h-screen overflow-x-hidden group/design-root bg-background-light dark:bg-background-dark shadow-2xl" dir="rtl">
      {/* Header / TopAppBar */}
        <div className="flex items-center bg-surface-light/90 dark:bg-surface-dark/90 backdrop-blur-md px-4 py-3 justify-between sticky top-0 z-20 shadow-[0_1px_2px_rgba(0,0,0,0.03)] dark:shadow-none border-b border-transparent dark:border-slate-800 transition-colors">
