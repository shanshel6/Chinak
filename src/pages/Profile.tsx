        ...
        <div className="flex-1 overflow-y-auto no-scrollbar pb-28 pb-safe">
          ...
          <div className="px-4 md:px-6 md:grid md:grid-cols-2 md:gap-8 items-start">
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-3xl p-5 shadow-sm border border-slate-100 dark:border-slate-700/50">
                <div className="flex items-center justify-between mb-4 px-1">
                  ...
                  <button 
                    ...
                    className="text-xs font-bold text-slate-400 dark:text-slate-500 flex items-center gap-1 active:opacity-70"
                  >
              ...
              {/* Account Settings */}
              <div>
                <h3 className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.1em] px-2 mb-3">{t('profile.account_settings')}</h3>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-[10px] text-slate-500 dark:text-slate-400">{t('profile.saved_addresses', { count: addressCount })}</p>
                      </div>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-[10px] text-slate-500 dark:text-slate-400">{t('profile.interested_products')}</p>
                      </div>
                    </div>
                    <ChevronLeft size={20} className="text-slate-300 dark:text-slate-600" />
                  </button>
              ...
              <div>
                <h3 className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.1em] px-2 mb-3">{t('profile.app_settings')}</h3>
                <div className="bg-white dark:bg-slate-800 rounded-3xl overflow-hidden shadow-sm border border-slate-100 dark:border-slate-700/50">
                  <div className="w-full flex items-center justify-between p-4 border-b border-slate-50 dark:border-slate-700/50">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-[10px] text-slate-500 dark:text-slate-400">{t('profile.notifications_desc')}</p>
                      </div>
                    </div>
            ...
            <div className="space-y-6 mt-6 md:mt-0 pb-6">
              ...
              {/* Support & About */}
              <div>
                <h3 className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.1em] px-2 mb-3">{t('profile.support_section')}</h3>
                <div className="bg-white dark:bg-slate-800 rounded-3xl overflow-hidden shadow-sm border border-slate-100 dark:border-slate-700/50">
                  <button 
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-[10px] text-slate-500 dark:text-slate-400">تواصل مع الدعم الفني مباشرة</p>
                      </div>
                    </div>
                    <ChevronLeft size={20} className="text-slate-300 dark:text-slate-600" />
                  </button>
              ...
              <div className="mt-8 px-2">
                ...
                <p className="text-center text-[10px] text-slate-400 dark:text-slate-500 mt-6 font-medium">Chinak v1.0.6</p>
              </div>
            </div>
          </div>
        </div>
