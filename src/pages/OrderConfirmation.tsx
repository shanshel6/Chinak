...
const OrderConfirmation: React.FC = () => {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden max-w-md mx-auto bg-background-light dark:bg-background-dark shadow-2xl font-display text-slate-900 dark:text-white antialiased selection:bg-primary/30 rtl" dir="rtl">
      {/* TopAppBar */}
      <div className="sticky top-0 z-50 bg-background-light/90 dark:bg-background-dark/90 backdrop-blur-md border-b border-slate-100 dark:border-slate-800">
      ...
      <main className="flex-1 flex flex-col items-center w-full px-4 pb-32">
          ...
          <div className="relative overflow-hidden bg-green-500/10 dark:bg-green-500/5 rounded-3xl border-2 border-green-500/20 p-6 flex flex-col items-center text-center gap-4">
            ...
            <div className="space-y-2">
              <p className="text-xl font-black text-green-700 dark:text-green-400 leading-tight">
                ستصلك رسالة عبر الواتساب قريباً بالتفاصيل
              </p>
              <p className="text-sm font-medium text-green-600/80 dark:text-green-400/60">
                يرجى التأكد من أن رقم هاتفك المسجل متاح على الواتساب
              </p>
            </div>
          </div>
        </div>
        ...
        {recommendations.length > 0 && (
          <div className="w-full mb-8">
            <h3 className="text-[#0d141b] dark:text-white text-sm font-bold mb-4 flex items-center justify-between">
        ...
        <div className="w-full mt-auto flex flex-col gap-3">
          ...
          <button 
            onClick={() => navigate('/')}
            className="flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-xl h-12 px-5 bg-transparent text-[#0d141b] dark:text-white text-base font-bold leading-normal tracking-[0.015em] border-2 border-slate-100 dark:border-slate-800 active:scale-95 transition-transform"
          >
            العودة للرئيسية
          </button>
        </div> 
        ...
        <div className="mt-6">
          <button 
            ...
            className="text-sm text-slate-400 dark:text-slate-500 hover:text-primary transition-colors flex items-center gap-1"
          >
            <Headset size={16} className="ml-1" />
