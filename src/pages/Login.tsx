        ...
        <form onSubmit={handleContinue} className="flex-1 px-6 flex flex-col gap-5">
            ...
            <>
              {step === 'phone' && (
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-[10px] text-slate-400 dark:text-slate-500 text-right mt-1 px-1">
                ...
                <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-right-4 duration-300">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex w-full items-stretch rounded-xl shadow-sm transition-all focus-within:ring-2 focus-within:ring-primary focus-within:ring-opacity-50">
                      <div className="flex items-center justify-center px-4 bg-surface-light dark:bg-surface-dark border border-slate-200 dark:border-slate-700 border-l-0 rounded-r-xl text-slate-400 dark:text-slate-500">
                        <Lock size={22} />
                      </div>
                      <input 
              ...
              {step === 'signup-name' && (
                <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-right-4 duration-300">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-xs text-slate-500 dark:text-slate-400">حساب جديد</span>
                  </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="text-center mt-6 p-2 bg-slate-100 dark:bg-slate-800/50 rounded-lg">
              <p className="text-xs text-slate-500 dark:text-slate-400 mb-1">الإصدار الحالي</p>
